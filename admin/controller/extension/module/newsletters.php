...
class ControllerExtensionModuleNewsletters extends Controller {
	...
	public function index() {
		...
		$this->load->model('axopc/newsletter');
		$this->model_axopc_newsletter->createNewsletter();
		...
		$this->load->model('axopc/newsletter');
		$result=$this->model_axopc_newsletter->getNewsLetter();
		$data['newsltr'] = array();
	...
	public function uninstall() {
		...
		$this->model_axopc_newsletter->dropNewsletter();
	}
