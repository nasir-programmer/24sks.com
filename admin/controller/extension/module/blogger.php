...
class ControllerExtensionModuleBlogger extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				$module_id = $this->model_axopc_blogger->addModule('blogger', $this->request->post);
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$results = $this->model_axopc_blogger->getBlogsByModule($this->request->get['module_id']);
		}

		if ($results) {
			foreach ($results as $result) {
				$total_comments = $this->model_axopc_blogger->getTotalBlogComments($result['blogger_id']);
	...
	public function install() {
		...
		$this->model_axopc_blogger->createBlogs();
	}

	public function uninstall() {
		$this->load->model('axopc/blogger');

		$this->model_axopc_blogger->dropBlogs();
	}
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_axopc_blogger->addBlog($this->request->post, $this->request->post['module_id']);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_axopc_blogger->editBlog($this->request->get['blogger_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $blogger_id) {
				$this->model_axopc_blogger->deleteBlog($blogger_id);
			}
			...
			$this->model_axopc_blogger->deleteBlog($this->request->get['blogger_id']);
	...
	public function getForm() {
		...
		if (isset($this->request->get['blogger_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$blogger_info = $this->model_axopc_blogger->getBlog($this->request->get['blogger_id']);
		}
		...
		if (isset($this->request->post['blogger_description'])) {
			...
			$data['blogger_description'] = $this->model_axopc_blogger->getBlogDescriptions($this->request->get['blogger_id']);
		} else {
	...
	private function getList() {
		...
		$blogger_total = $this->model_axopc_blogger->getTotalBlogs();

		$results = $this->model_axopc_blogger->getBlogs($filter_data);
		...
		foreach ($results as $result) {
			$module_info = $this->model_axopc_blogger->getModule($result['module_id']);
	...
	public function getComments() {
		...
		$blog_info = $this->model_axopc_blogger->getBlog($this->request->get['blogger_id']);

		$blog_title = $this->model_axopc_blogger->getBlogTitle($this->request->get['blogger_id']);
		...
		$blog_comment_total = $this->model_axopc_blogger->getTotalBlogComments($this->request->get['blogger_id']);

		$results = $this->model_axopc_blogger->getBlogComments($this->request->get['blogger_id'], $filter_data);
	...
	public function approve_comment() {
		...
		$this->model_axopc_blogger->approveComment($this->request->get['blogger_comment_id']);
	...
	public function disapprove_comment() {
		...
		$this->model_axopc_blogger->disapproveComment($this->request->get['blogger_comment_id']);
	...
	public function delete_comment() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $blogger_comment_id) {
				$this->model_axopc_blogger->deleteBlogComment($blogger_comment_id);
			}
	...
	protected function viewComment() {
		...
		$comment_info = $this->model_axopc_blogger->getBlogComment($this->request->get['blogger_comment_id']);

		$comment_descriptions = $this->model_axopc_blogger->getBlogCommentDescriptions($this->request->get['blogger_comment_id']);
